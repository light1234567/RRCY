...
class IndicatorOfSocialFunctioningController extends Controller
{
    ...
    private function validateRequest(Request $request)
    {
        ...
        'physical_raw_score1' => 'nullable|integer|min:0|max:100',
        'physical_score_per_area1' => 'nullable|numeric|min:0|max:100',  // Decimal score per area
        'physical_raw_score2' => 'nullable|integer|min:0|max:100',
        'emotional_raw_score1' => 'nullable|integer|min:0|max:100',
        'emotional_score_per_area1' => 'nullable|numeric|min:0|max:100',  // Decimal score per area
        'emotional_raw_score2' => 'nullable|integer|min:0|max:100',
        'emotional_raw_score3' => 'nullable|integer|min:0|max:100',
        'emotional_raw_score4' => 'nullable|integer|min:0|max:100',
        'emotional_raw_score5' => 'nullable|integer|min:0|max:100',
        'emotional_raw_score6' => 'nullable|integer|min:0|max:100',
        'social_raw_score1' => 'nullable|integer|min:0|max:100',
        'social_score_per_area1' => 'nullable|numeric|min:0|max:100',  // Decimal score per area
        'social_raw_score2' => 'nullable|integer|min:0|max:100',
        'social_raw_score3' => 'nullable|integer|min:0|max:100',
        'social_raw_score4' => 'nullable|integer|min:0|max:100',
        'social_raw_score5' => 'nullable|integer|min:0|max:100',
        'social_raw_score6' => 'nullable|integer|min:0|max:100',
        'social_raw_score7' => 'nullable|integer|min:0|max:100',
        'social_raw_score8' => 'nullable|integer|min:0|max:100',
        'spiritual_raw_score1' => 'nullable|integer|min:0|max:100',
        'spiritual_score_per_area1' => 'nullable|numeric|min:0|max:100',  // Decimal score per area
        'educational_raw_score' => 'nullable|integer|min:0|max:100',
        'educational_score_per_area' => 'nullable|numeric|min:0|max:100',  // Decimal score per area
        'economic_raw_score' => 'nullable|integer|min:0|max:100',
