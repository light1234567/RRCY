<template>
  ...
  const clients = ref([
    { id: '001', name: 'Justine Parilla', crimeStatus: 'Crime Against Person' },
    { id: '002', name: 'Rowel Borden', crimeStatus: 'Crime Against Property' },
    { id: '003', name: 'Rich Rhyan Camellon', crimeStatus: 'Crime Against Person' },
    { id: '004', name: 'Michael Brown', crimeStatus: 'Crime Against Person' },
    { id: '005', name: 'Emily Davis', crimeStatus: 'Crime Against Property' },
    { id: '006', name: 'William Wilson', crimeStatus: 'Crime Against Property' },
    { id: '007', name: 'Sophia Martinez', crimeStatus: 'Crime Against Property' },
    { id: '008', name: 'James Anderson', crimeStatus: 'Crime Against Property' },
    { id: '009', name: 'Olivia Thomas', crimeStatus: 'Crime Against Person' },
    { id: '010', name: 'Liam Taylor', crimeStatus: 'Crime Against Person' },
    { id: '011', name: 'Isabella White', crimeStatus: 'Crime Against Person' },
    { id: '012', name: 'Noah Harris', crimeStatus: 'Crime Against Property' },
    { id: '013', name: 'Mia Clark', crimeStatus: 'Crime Against Property' },
    { id: '014', name: 'Lucas Lewis', crimeStatus: 'Crime Against Property' },
    { id: '015', name: 'Amelia Walker', crimeStatus: 'Crime Against Property' },
  ]);
