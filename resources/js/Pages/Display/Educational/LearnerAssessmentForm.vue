...
<table class="w-full border-collapse mb-6">
  <thead>
    <tr class="bg-transparent text-sm" style="height: 10px;">
      ...
      <th class="border border-black p-2 text-left"></th>
      <th class="border border-black p-2 text-center">Remarks</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td class="border text-sm font-semibold border-black p-2" style="width: 240px;">Pronunciation of Words</td>
      <td class="border text-[12px] align-top border-black p-2">The learner struggles to pronounce the words.</td>
      <td class="border text-[12px] align-top border-black p-2">Some words are pronounced correctly</td>
  ...
  class="w-full p-1 text-sm border-none text-center" v-model="form.assessments.reading.pronunciation_remarks" :readonly="!isEditable" rows="6" style="height: 270px; padding-top: 90%; line-height: 1; resize: none;"> </textarea>
    ...
    <tr>
      <td class="border text-sm font-semibold border-black p-2">Fluency of Reading</td>
      <td class="border text-[12px] align-top border-black p-2">Struggles to read.</td>
      <td class="border text-[12px] align-top border-black p-2">Reads word for word</td>
    ...
    <tr>
      ...
      <td class="border text-[12px] align-top border-black p-2">Punctuation marks are ignored.</td>
      <td class="border text-[12px] align-top border-black p-2">Punctuation marks replaced with a breath</td>
      ...
      <table class="w-full border-collapse mb-6">
        <thead>
          <tr class="bg-transparent text-sm" style="height: 10px;">
            <th class="border border-black p-2 text-left"></th>
            <th class="border border-black p-2 text-left"></th>
            <th class="border border-black p-2 text-center" rowspan="5" >Remarks</th>
          </tr>
        </thead>
        <tbody class="text-sm">
          <tr>
            <td class="border border-black p-2 font-semibold">Advance</td>
            <td class="border border-black p-2" style="height: 50px;">
            ...
            <td class="border border-black p-2" rowspan="5" style="width: 150px;" >
              <textarea class="w-full p-1 text-sm text-center border-none" v-model="form.assessments.reading.advance_remarks" :readonly="!isEditable" rows="6" style="height: 600px; padding-top: 150%; line-height: 1; resize: none;" ></textarea>
            </td>
          </tr>
          <tr>
            <td class="border border-black p-2 font-semibold">Proficient</td>
          ...
          <tr>
            <td class="border border-black p-2 font-semibold">Developing</td>
            <td class="border border-black p-2">
          ...
          <tr>
            <td class="border border-black p-2 font-semibold">Emerging</td>
            <td class="border border-black p-2">
          ...
          <tr>
            <td class="border border-black p-2 font-semibold">Beginning</td>
            <td class="border border-black p-2">
...
<table class="w-full border-collapse mb-6">
  <thead>
    <tr class="bg-transparent text-[11px]" style="height: 10px;">
      <th class="border border-black p-2 text-left"></th>
  ...
  <tbody class="text-xs">
    <tr>
      <td class="border border-black p-2" style="width: 300px;"> <span class="font-semibold"> Punctuation </span><br/>He uses accurate punctuation. </td>
      ...
      <td class="border border-black p-2" rowspan="5" style="width: 150px;">
        <textarea class="w-full text-sm text-center p-1 border-none" v-model="form.assessments.writing.punctuation_remarks" :readonly="!isEditable" rows="5" style="height: 350px; padding-top: 120%; line-height: 1; resize: none;"></textarea>
      </td>   </tr>
    <tr>
      <td class="border border-black p-2" style="width: 300px;" ><span class="font-semibold">Capitalization </span><br /> He uses capital letters to begin sentences and for names. </td>
    ...
    <tr>
      <td class="border border-black p-2" style="width: 300px;"><span class="font-semibold">Grammar</span> <br />He uses subject/verb agreement and writes complete sentences that make sense. </td>
    ...
    <tr>
      <td class="border border-black p-2" style="width: 300px;"><span class="font-semibold">Content/Ideas </span><br />He writes on topic and adds details</td>
    ...
    <tr>
      <td class="border border-black p-2" style="width: 300px;"><span class="font-semibold">Spelling </span><br />He writes most sight words correctly and applies spelling rules</td>
      ...
      <table class="w-full border-collapse mb-6">
        <thead>
          <tr class="bg-transparent text-sm">
            <th class="border border-black p-2 text-left"></th>
            <th class="border border-black p-2 text-left"></th>
            <th class="border border-black p-2 text-center" rowspan="4">Remarks</th>
          </tr>
        </thead>
        <tbody class="text-sm">
          <tr>
            <td class="border border-black  text-sm font-semibold p-2">Advance</td>
            <td class="border border-black p-2">
            ...
            <td class="border border-black p-2" rowspan="4" style="width: 150px;">
        <textarea class="w-full text-center text-sm p-1 border-none" v-model="form.assessments.numeracy.advance_remarks" :readonly="!isEditable" rows="6" style="height: 560px; padding-top: 250%; line-height: 1; resize: none;"></textarea>
      </td>
          </tr>
          <tr>
            <td class="border border-black text-sm font-semibold  p-2">Proficient</td>
            <td class="border border-black p-2">
              <ul class="list-disc list-inside">
          ...
          <tr>
            <td class="border border-black text-sm font-semibold p-2">Developing</td>
            <td class="border border-black p-2">
              <ul class="list-disc list-inside">
          ...
          <tr>
            <td class="border border-black text-sm font-semibold p-2">Emerging</td>
            <td class="border border-black p-2">
              <ul class="list-disc list-inside">
...
<table class="w-full border-collapse mb-6">
  <thead>
    <tr class="bg-transparent text-xs">
      <th class="border border-black p-2 text-left"></th>
  ...
  <tbody class="text-sm">
    <tr>
      <td class="border border-black p-2" style="width: 350px;">Participated in group work</td>
      ...
      <td class="border border-black p-2" rowspan="6" style="width: 190px;">
        <textarea class="w-full text-sm text-center p-1 border-none" v-model="form.assessments.group_work.participation_remarks" :readonly="!isEditable" rows="6" style="height: 200px; padding-top: 50%; line-height: 1; resize: none;"></textarea>
      </td>   </tr>
    <tr>
