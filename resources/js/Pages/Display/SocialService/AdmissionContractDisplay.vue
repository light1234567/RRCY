<template>
  ...
  <div class="graph-background pt-0.5  -mr-9 -mb-16">
    ...
    <!-- Page 2 Content -->
    <div v-if="currentPage === 2" class="max-w-3xl p-16 bg-white shadow-xl rounded-lg mx-auto my-8 border border-gray-400">
      ...
      <ol class="list-decimal ml-6 space-y-2 text-justify" start="4">
  ...
  pdf.addImage(footerImgData, 'PNG', 175, 330, 25, 12); // Adjust the position and size
    ...
    contentYPos = 15; // Reset Y position for the new page
    pdf.setFontSize(12);
    pdf.setFont('arial', 'normal');
    ...
    pdf.setFont('arial', 'normal');
    pdf.setFontSize(12);
    pdf.text('Signature above-completed Name of CICL', 20, contentYPos);
    ...
    pdf.line(initialX, contentYPos, initialX + 80, contentYPos);
    contentYPos += 5;
    pdf.setFont('arial', 'normal');
    pdf.setFontSize(12);
    pdf.text('RRCY Administering Officer', initialX, contentYPos);
    ...
    pdf.setFont('arial', 'normal');
    pdf.setFontSize(12);
    pdf.text('Signature above-completed Name of', 20, contentYPos);
    pdf.text('Parent/ Custodian', 20, contentYPos+5);
    ...
    pdf.setFont('arial', 'normal');
    pdf.setFontSize(12);
    pdf.text('Houseparent-On Duty', initialX, contentYPos);
  
    contentYPos += 20;
    pdf.text(`${this.form.lgu_worker_name || ''}`, initialX+-90, contentYPos+-2);
    pdf.line(20, contentYPos, 100, contentYPos);
    contentYPos += 5;
    pdf.setFont('arial', 'normal');
    pdf.setFontSize(12);
    pdf.text('Signature above-completed Name of LGU', 20, contentYPos);
    pdf.text('Worker', 20, contentYPos+5);
    ...
    // Save the PDF
    pdf.save('admission_contract_legal.pdf');
  }
