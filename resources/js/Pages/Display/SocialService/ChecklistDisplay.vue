<template>
  <div>
    ...
    <!-- Page 1 of 2 -->
    <div v-if="currentPage === 1" class="w-1/2 p-6 bg-white shadow-xl rounded-lg mx-auto my-8 border border-gray-200">
      <div class="relative flex justify-between items-center mb-2">
        <img src="/images/headerlogo2.png" alt="Logo" class="h-16 w-32 relative z-10">
        <p class="text-[8px]">DSPDP-GF-010A | REV.00 | 12 SEP 2023</p>
      </div>

      <h1 class="text-xs font-bold mb-4 text-center text-black">Checklist of Requirements during Admission</h1>
    ...
    <!-- Page 2 of 2 -->
    <div v-if="currentPage === 2" class="w-1/2 p-6 bg-white shadow-xl rounded-lg mx-auto my-8 border border-gray-200">
